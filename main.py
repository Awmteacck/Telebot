...
import os
token = '7175703585:AAHMGHu_ggfNh1D5EZakddJ0OeKK80AI5uI'
bot=telebot.TeleBot(token,parse_mode="HTML")
subscriber = '7237320756'
@bot.message_handler(commands=["start"])
def start(message):
	if not str(message.chat.id) == '-1002493542474':
		bot.reply_to(message, "You cannot use the bot to contact developers to purchase a bot subscription @Awmtee")
		return
